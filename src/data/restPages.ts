export const REST_PAGES: Record<string, any> = {
  kinza: {
    ...
    about: [
      'Кинза — ресторан грузинской национальной кухни. Здесь приятно не только завтракать, обедать или ужинать, но и просто проводить время, поглядывая в огромного размера окна и рассматривая детали интерьера.',
