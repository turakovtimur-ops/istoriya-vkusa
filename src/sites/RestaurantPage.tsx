    ...
    <section id="menu" className={'scroll-mt-40 py-16 lg:py-24 px-6 lg:px-12 border-y ' + lineB} style={{ background: secBg }}>
      ...
      <footer className="bg-graphite text-cream">
        ...
        <div className="border-t border-cream/10 py-5 text-center px-6">
          <a href="#/" className="text-[10px] uppercase tracking-[0.3em] text-cream/50 hover:text-cream transition-colors">© 2026 {restaurant.name} · Часть холдинга «История Вкуса» · Кастомная разработка и дизайн сайта — Тураков Т. Р.</a>
        </div>
      </footer>
